              ...
              while ($row = $result->fetch_assoc()) {
                  ...
                  if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      $stmt->bind_param("sssssssssssssss", $today, $barcode, $product_name, $pieces_price, $qty, $pieces_price, $random, $customer, $payment, $type, $exp_debt, $orderNumber,$discount,$buy_type,$user_id);
                      if ($stmt->execute()) {
                          $errorMessage = "update_data success";
                      } else {
                          $errorMessage = "Error: " . $stmt->error;
  ...
  ?>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
            <a href="pages/addCustomer.php" class="nav-link">
            ...
            <li class="nav-item">
            <a href="pages/addStaff.php" class="nav-link">
                <i class="nav-icon fas fa-copy"></i>
                <p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/detail_day.php" class="nav-link <?=$pageName == 'detail_day.php' ? 'active' : '';?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ရက်ချုပ်</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="pages/detail_year.php" class="nav-link <?=$pageName == 'detail_year.php' ? 'active' : '';?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>နှစ်ချုပ်</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="pages/log_out.php" class="nav-link <?=$pageName == 'log_out.php' ? 'active' : '';?>">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Account ထွက်ရန်
              </p>
        ...
        <div class="form-res">
          <form id="dataForm">
            ...
            <div class="d-md-flex justify-content-around align-items-left mb-3 mt-2">
              ...
              <div class="pr-3 pl-3 pb-3 w-sm-100 w-lg-50"><button type="button" class="btn btn-primary btn-sm submit" value="refresh" id="reset">Save</button></div>
