        ...
        while($row = $result->fetch_assoc()) {
            ...
            if ($result && $result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  $sql = "SELECT package_exist,unit_exist,pieces_exist FROM product WHERE barcode='$barcode'";
                  $result = $connection->query($sql);
                  if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      if ($package_exist < 1){
                        include "dialog_box.html";
                      }

                      else if ( $unit_exist < 1){
                        include "dialog_box.html";
                      }

                      else if ($pieces_exist< 1){
                        include "dialog_box.html";
                      }
                  ...
                  if ($stmt->execute()) {
                    ...
                    $stmt = $connection->prepare("INSERT INTO sell_data (date, barcode, product_name, price, qty, total, tra_id, customer, bill, type, exp_debt, voucher,discount,buy_type,seller) VALUES (?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)");
                    $stmt->bind_param("sssssssssssssss", $today, $barcode, $product_name, $pieces_price, $qty, $pieces_price, $random, $customer, $payment, $type, $date, $orderNumber,$discount,$buy_type,$user_id);
  ...
  ?>
    ...
    <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item <?=$pageName == 'pages/addCustomer.php'? 'menu-open' : '';?> <?=$pageName == 'pages/customer_payment.php'? 'menu-open' : '';?>">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="pages/addCustomer.php" class="nav-link <?=$pageName == 'pages/addCustomer.php' ? 'active' : '';?>">
                      <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                    <a href="pages/customer_payment.php" class="nav-link <?=$pageName == 'pages/customer_payment.php' ? 'active' : '';?>">
                      <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
          <a href="pages/addStaff.php" class="nav-link <?=$pageName == 'pages/addStaff.php' ? 'active' : '';?>">
              <i class="nav-icon fas fa-copy"></i>
              <p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/detail_day.php" class="nav-link <?=$pageName == 'pages/detail_day.php' ? 'active' : '';?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>ရက်ချုပ်</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="pages/detail_month.php" class="nav-link <?=$pageName == 'pages/detail_month.php' ? 'active' : '';?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>လချုပ်</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="pages/detail_year.php" class="nav-link <?=$pageName == 'pages/detail_year.php' ? 'active' : '';?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>နှစ်ချုပ်</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="pages/log_out.php" class="nav-link <?=$pageName == 'pages/log_out.php' ? 'active' : '';?>">
              <i class="nav-icon fas fa-table"></i>
              <p>
                Account ထွက်ရန်
              </p>
        ...
        <div class="form-res">
          ...
          <td class="td-reduce-padding w-100"><input class="w-100" type="text" name="rate"  id="orderNumber"  value="'.$last_voucher.'"></td>         
            ...
            <div class="d-md-flex justify-content-around align-items-center mb-3 mt-2">
              ...
              <div class="pr-3 pl-3 pb-3 w-sm-100 w-lg-25"><button type="button" class="btn btn-primary btn-sm submit" value="refresh" id="reset">Save</button></div>
