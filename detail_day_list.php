  ...
  <div class="voucher-container">
        ...
        <td colspan="2" class="voucher-header">
            ...
            <?php
              ...
              if (isset($_GET['date'])) {
                ...
                echo'<h3 style="text-align:left;font-size:12px;">Date: '.$date.'</h3>';
    ...
    <?php
      ...
      if ($connection->connect_error) {
        ...
        $sql = "SELECT * FROM sell_data WHERE date='$date'";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $sql = "SELECT SUM(total) AS total_sum, SUM(discount) As total_discount from sell_data where date='$date'"; // Use an alias "total_sum" for the sum(total) column
            $result = $connection->query($sql);
